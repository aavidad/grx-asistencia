...
import os, subprocess,sys,socket, apt
from sshtunnel import SSHTunnelForwarder
from shutil import copyfile
import tablabel,usuarios_on,usuarios_off,informacion,libreria
import threading,random,glob
reload(sys)  
...
##############################
		mensaje('No se ha podido ejecutar nmap en el equipo remoto',"Atencion",atencion)	
		...
		#try:
			...
			if tmp=="":
				dialogo=Gtk.MessageDialog(self, 0, Gtk.MessageType.WARNING,Gtk.ButtonsType.OK_CANCEL, "Atencion hplip no instalado")
			        dialog.format_secondary_text("Pulse aceptar si desea instalarlo")		        
