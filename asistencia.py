...
import logging
import tablabel
import equipos_linux,equipos_win,impresoras,router,desconocido,libreria
...
def conecta():
	...
	try:
		...
		self.mensaje ("Error al intentar conectar con "+ip)
...
def crea_lista():
	...
	try:
		...
		print "No ha sido posible leer el archivo sedes.txt.cvs"
